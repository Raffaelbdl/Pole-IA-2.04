...
parser.add_argument('--workers', type=int, default=6, help='Dataloading workers per GPU')
...
class Engine(object):
	...
	def validate(self, model, args, dataloader_val):
		...
		print("=============================================================================\nLoop de validation 1H MAX -> Pitié attendre la fin\n=============================================================================")
...
def main():
	...
	for epoch in range(trainer.cur_epoch, args.epochs):
		print("=============================================================================\nTraining loop, ça dure 4H puis y'a une loop de validation d'1H, pas de problème pour couper temporairement mais relancer : python train.py\n=============================================================================")
		...
		if epoch % args.val_every == 0: 
			...
			print("=============================================================================\nEpoch finie, vous pouvez lancer autre chose et relancer : python train.py après merci ^^ UwU\n=============================================================================")

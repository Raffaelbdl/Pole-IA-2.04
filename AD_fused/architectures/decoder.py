...
class Decoder(nn.Module):
    ...
    def __init__(self, dim, num_class, input_size, hidden_size, n_blocks, 
        ...
        self.fc_att = nn.Conv1d(hidden_size, 2*seq_len * anchors * n_cam, 1)
